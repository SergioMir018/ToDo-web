  ...
  return (
      <div className="flex flex-col items-center">
        ...
        <div className="flex mt-4 py-5">
            <img src="../../../public/images/6926528.webp" alt="An images that resembles the process of organizing a  project" className="max-h-96 translate-x-80 rounded-xl z-10 " />
        <ul className="pl-80 -translate-y-3 -translate-x-28">
          <li className="pl-80 bg-slate-600 p-2 rounded-lg pt-5 mb-3 text-end">
          ...
          <li className="pl-80 bg-slate-600 p-2 rounded-lg mb-3 text-end">
                <p className="font-belanosima text-xl text-slate-300">
          ...
          <li className="pl-80 bg-slate-600 p-2 pb-6 rounded-lg text-end">
                <p className="font-belanosima text-xl text-slate-300">
