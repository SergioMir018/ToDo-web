        ...
        <ul className="-translate-y-6 -translate-x-36">
          ...
          <li className="pl-80 bg-slate-600 py-4 rounded-lg mb-3 text-center animate-fade-left animate-once animate-duration-[500ms] animate-delay-200">
            <p className="font-belanosima text-xl text-white -translate-x-32">
              ...
              . Our app <br /> helps you break down your tasks into manageable{" "}
              <br />
              <span className="text-sky-500">steps</span>, so you can tackle
              them one at a time <br /> and feel a sense of accomplishment along
              the way.
            </p>
          </li>
          <li className="pl-80 bg-slate-600 pt-2 pb-7 rounded-lg text-center animate-fade-left animate-once animate-duration-[500ms] animate-delay-300">
            <p className="font-belanosima text-xl text-white -translate-x-32 translate-y-2">
              ...
              notes - our app <br /> gives you a clean and streamlined way to
              manage <br /> your tasks and{" "}
              <span className="text-sky-500">stay organized</span>.
            </p>
          </li>
        </ul>
      </div>
      <section className="flex items-center gap-4">
        <h2 className="text-white font-belanosima text-xl">
          Are you{" "}
          <strong className="bg-gradient-to-r text-transparent   bg-clip-text from-indigo-500 via-purple-500 to-pink-500">
            new
          </strong>{" "}
          ?
        </h2>
          <Link
            to="/ToDo-web/sing-up"
            className="py-1 px-3 cursor-pointer select-none rounded-lg border-2 active:border-purple-500 active:bg-gray-700 hover:bg-slate-50 text-white font-belanosima-semibold hover:text-black active:text-white  transition duration-150"
          >
