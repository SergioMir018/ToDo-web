  ...
  return (
    <article className="flex flex-col items-center">
      ...
      <div className="flex mt-4 py-5">
        <img src="../../assets/images/6926528.webp" width="384" height="384" alt="An images that resembles the process of organizing a  project" className="max-h-96 shadow-2xl shadow-slate-900 translate-x-24 rounded-xl z-10 animate-fade-right animate-once animate-duration-[1200ms]" />
