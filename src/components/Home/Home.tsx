  ...
  return (
    <article className="flex flex-col items-center">
      ...
      <div className="flex mt-4 py-5">
        <img src="public/images/6926528.webp" width="384" height="384" alt="An images that resembles the process of organizing a  project" className="max-h-96 shadow-2xl shadow-slate-900 translate-x-24 rounded-xl z-10 animate-fade-right animate-once animate-duration-[1200ms]" />
        <ul className="-translate-y-6 -translate-x-36">
          <li className="pl-80 bg-slate-600 p-2 rounded-lg pt-6 pb-2 mb-3 text-center animate-fade-left animate-once animate-duration-[1200ms] animate-delay-200">
            <p className="font-belanosima text-xl text-slate-300 -translate-y-2 -translate-x-32">
          ...
          <li className="pl-80 bg-slate-600 py-4 rounded-lg mb-3 text-center animate-fade-left animate-once animate-duration-[1200ms] animate-delay-300">
            <p className="font-belanosima text-xl text-slate-300 -translate-x-32">
          ...
          <li className="pl-80 bg-slate-600 pt-2 pb-7 rounded-lg text-center animate-fade-left animate-once animate-duration-[1200ms] animate-delay-500">
            <p className="font-belanosima text-xl text-slate-300 -translate-x-32 translate-y-2">
      ...
      <section className="flex items-center gap-4">
        ...
        <div className="py-1 px-3 rounded-lg border-2 group hover:bg-slate-50 transition duration-150">
          <a href="#" className="text-white font-belanosima-semibold group-hover:text-black transition duration-150">
